                    ...
                    <ul className="text-left border rounded">
                      {localidadeCatering.map((localidadeItem, index) => (
                        <li
                          ...
                          onClick={() => handleSelectLocalidade(localidadeItem)}
                        >
                          {localidadeItem}
                        </li>
                      ))}
            ...
            <div className="w-full md:w-1/2">
              <div className="mr-10 mb-5">
                ...
                <div className="relative flex justify-left items-left pt-2">
                  ...
                  >
                    <p className="px-4 text-gray-400">
                      {selectedTipoComida || 'Tipo de Comida'}
                    </p>
                    <div className="flex items-center">
                      <div className="bg-customBlue p-2 hover:bg-gray-100 rounded-r">
                        <FaChevronDown />
                      ...
                      <ul className="text-left border rounded">
                        {tipoComida.map((tipoComidaItem, index) => (
                          <li
                            ...
                            className="px-4 py-1 hover:bg-gray-100 border-b"
                            onClick={() =>
                              handleSelectTipoComida(tipoComidaItem)
                            }
                          >
                            {tipoComidaItem}
                          </li>
                    ...
                    <ul className="text-left border rounded">
                      {precoCatering.map((precoItem, index) => (
                        <li
                          key={index}
                          className="px-4 py-1 hover:bg-gray-100 border-b"
                          onClick={() => handleSelectPreco(precoItem)}
                        >
                          {precoItem}
                        </li>
                      ))}
